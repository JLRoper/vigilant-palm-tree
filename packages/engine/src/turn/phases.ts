...
// server-authoritative — see POST /games/:name/resolve-battle (server/routes.ts)
// and packages/engine/src/combat/resolveBattle.ts for the resolver.
// This just closes out the local BATTLE phase once the caller has the server's result in hand;
// heroes/players are merged in separately.
