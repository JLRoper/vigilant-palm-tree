// FLUX isometric building sprite generator - market level 2.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-market-l2.mjs
...
const JOBS = [
  {
    name: "building-classic-market-2.png",
    prompt: "Single isolated pixel art isometric fantasy grand marketplace, large open-air trading hall with wooden beamed roof and four colorful striped awnings red-yellow-blue-green, multiple merchant stalls with overflowing barrels of grain and crates of textiles, central cobblestone plaza with ornate fountain, hanging lanterns and trade banners, busy mercantile atmosphere, viewed from 3/4 angle, dark saturated colors, fills the entire canvas, pixel art, black outlines"
  },
];
