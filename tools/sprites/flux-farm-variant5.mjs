// FLUX isometric farm field - variant 5.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-farm-variant5.mjs
...
const JOBS = [
  {
    name: "building-classic-farmField-1-variant5.png",
    prompt: "A flat farm field with freshly tilled dark rich soil and tiny green sprouts in neat rows, designed as a floating 3D isometric tile. Orthographic projection, clean axonometric view, perfect 30-degree angle grid, no perspective distortion. Soft morning light, isolated on a solid neutral gray background.",
    seed: 10040,
  },
];
