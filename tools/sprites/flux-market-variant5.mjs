// FLUX isometric market building - variant 5.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-market-variant5.mjs
...
const JOBS = [
  {
    name: "building-classic-market-1-variant5.png",
    prompt: "Single isolated pixel art isometric fantasy open-air market square with three wooden vendor carts arranged in a triangle, one selling fish on ice, one selling cloth and textiles, one selling spices in sacks, central stone pedestal with weighing scales, cobblestone ground, viewed from 3/4 angle, dark saturated colors, fills the entire canvas, pixel art, black outlines",
  },
];
