// FLUX isometric building sprite generator - townHall level 2.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-townHall-l2.mjs
...
const JOBS = [
  {
    name: "building-classic-townHall-2.png",
    prompt: "Single isolated pixel art isometric fantasy large town hall civic building, two stories with grand gray stone walls and dark red tile roof, tall bell tower with clock face, wide stone steps leading to columned entrance, large double wooden doors, blue and gold banners hanging from walls, town square courtyard in front, viewed from 3/4 angle, dark saturated colors, fills the entire canvas, pixel art, black outlines"
  },
];
