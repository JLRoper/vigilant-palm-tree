// FLUX isometric farm field - variant 2 (lettuce & cabbage).
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-farm-variant2.mjs
...
const JOBS = [
  {
    name: "building-classic-farmField-1-variant2.png",
    prompt: "A flat farm field with neat diagonal rows of alternating green lettuce and cabbage crops, designed as a floating 3D isometric tile. Orthographic projection, clean axonometric view, perfect 30-degree angle grid, no perspective distortion. Bright uniform lighting, isolated on a solid neutral gray background.",
  },
];
