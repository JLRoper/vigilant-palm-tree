// FLUX isometric market building - variant 2.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-market-variant2.mjs
...
const JOBS = [
  {
    name: "building-classic-market-1-variant2.png",
    prompt: "Single isolated pixel art isometric fantasy marketplace with a large blue-and-white striped fabric awning canopy, wooden countertops displaying colorful fruit and vegetable baskets, hanging scale, cobblestone base with a small fountain, viewed from 3/4 angle, dark saturated colors, fills the entire canvas, pixel art, black outlines",
  },
];
