// FLUX isometric building sprite generator - farm field level 1.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-farmField-l1.mjs
...
const JOBS = [
  {
    ...
    prompt: "Single isolated pixel art isometric fantasy tilled farm field, diamond-shaped isometric plot showing rows of green crops on dark brown soil, tiny scarecrow in corner, wooden fence posts around the edges, small irrigation ditch, viewed from true 3/4 isometric angle showing top and two side faces, dark saturated earthy colors, fills the entire canvas, pixel art, black outlines"
  },
];
