// Iso-pile-smol regen — same FLUX prompts/seeds as flux-piles.mjs but
// without the 2px outline post-process, saved as -pile-smol.png so both
// the outlined large version and the no-outline small version stay
// available side-by-side in the asset system.
...
const JOBS = [
  {
    name: "resource-gold-pile-smol.png",
    seed: 7000,
  ...
  {
    name: "resource-wood-pile-smol.png",
    seed: 7001,
