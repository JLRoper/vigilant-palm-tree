// FLUX isometric building sprite generator - house level 1.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-house-l1.mjs
...
const JOBS = [
  {
    name: "building-classic-house-1.png",
    prompt: "Single isolated pixel art isometric fantasy small cozy cottage, single story with brown wooden walls and warm orange-brown thatched roof, stone chimney with light smoke, two small yellow-lit windows, wooden front door, cottage garden with tiny fence, viewed from 3/4 angle, dark saturated colors, fills the entire canvas, pixel art, black outlines"
  },
];
