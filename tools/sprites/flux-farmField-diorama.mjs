// FLUX isometric farm field - diorama style.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-farmField-diorama.mjs
...
const JOBS = [
  {
    ...
    prompt: "A flat farm field with neat rows of green crops, designed as a floating 3D isometric diorama tile. Orthographic projection, clean axonometric view, perfect 30-degree angle grid, no perspective distortion. The edges of the field are cleanly cut like a solid 3D block showing layers of soil beneath. Bright uniform lighting, isolated on a solid neutral gray background.",
  },
];
