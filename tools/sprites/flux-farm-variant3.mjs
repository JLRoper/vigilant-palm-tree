// FLUX isometric farm field - variant 3 (golden wheat).
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-farm-variant3.mjs
...
const JOBS = [
  {
    name: "building-classic-farmField-1-variant3.png",
    prompt: "A flat farm field with neat rows of golden wheat crops, designed as a floating 3D isometric tile. Orthographic projection, clean axonometric view, perfect 30-degree angle grid, no perspective distortion. Warm golden hour lighting, isolated on a solid neutral gray background.",
  },
];
