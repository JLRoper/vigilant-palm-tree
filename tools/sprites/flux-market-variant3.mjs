// FLUX isometric market variant 3.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-market-variant3.mjs
...
const JOBS = [
  {
    name: "building-classic-market-1-variant3.png",
    prompt: "Single isolated pixel art isometric fantasy marketplace with two green canvas-covered merchant stalls side by side, wooden barrels and stacked crates of goods, lantern hanging from center beam, stone well to the side, viewed from 3/4 angle, dark saturated colors, fills the entire canvas, pixel art, black outlines",
  },
];
