// FLUX isometric farm field variant 4 - floating tile style.
//
// Usage:
//   $env:DEEPINFRA_API_KEY = "..." ; node tools/sprites/flux-farm-variant4.mjs
...
const JOBS = [
  {
    name: "building-classic-farmField-1-variant4.png",
    prompt: "A flat farm field with neat rows of tall corn stalks, designed as a floating 3D isometric tile. Orthographic projection, clean axonometric view, perfect 30-degree angle grid, no perspective distortion. Overcast cool lighting, isolated on a solid neutral gray background.",
  },
];
...
for (const job of JOBS) {
  ...
  try {
    ...
    const raw = await gen(job.prompt, 10030);
